...
//---- indicator digits
   ...
   tickChartIndicator.SetGetVolumesFlag();
//----
  }
//+------------------------------------------------------------------+
//|  Volumes                                                         |
...
//--- main cycle
   if(InpVolumeType==VOLUME_TICK)
      CalculateVolume(start,rates_total,tickChartIndicator.Tick_volume);
   else
      CalculateVolume(start,rates_total,tickChartIndicator.Real_volume);
