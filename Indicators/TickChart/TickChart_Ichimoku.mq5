...
//
// Initialize TickChart indicator for data processing 
// according to settings of the TickChart indicator already on chart
//
...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   //
   // customChartIndicator.IsNewBar (true/false) informs you if a tick chart bar completed
   //
